              ...
              <CardContent className="space-y-6">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-[var(--text-tertiary)]">{profile.class} • {profile.studentId}</p>
                    <Badge variant="primary" className="mt-1">Học sinh</Badge>
                  </div>
                </div>
                ...
                <div className="grid gap-4">
                  ...
                  <Input
                    ...
                    disabled
                    leftIcon={<GraduationCap className="h-5 w-5" strokeWidth={1.75} />}
                  />
              ...
              <CardContent className="space-y-6">
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    {[
                      { key: 'emailNewAssignment', label: 'Bài tập mới', desc: 'Nhận email khi có bài tập mới' },
                      { key: 'emailGradeNotify', label: 'Điểm số', desc: 'Nhận email khi bài được chấm điểm' },
                      { key: 'emailReminder', label: 'Nhắc nhở deadline', desc: 'Nhắc nhở trước khi hết hạn nộp bài' },
                    ].map((item) => (
                      <label
                        key={item.key}
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    {[
                      { key: 'pushNewAssignment', label: 'Bài tập mới', desc: 'Thông báo khi có bài tập mới' },
                      { key: 'pushGrade', label: 'Điểm số', desc: 'Thông báo khi bài được chấm điểm' },
                      { key: 'pushDeadline', label: 'Sắp hết hạn', desc: 'Nhắc nhở 24h trước deadline' },
                    ].map((item) => (
                      <label
                        key={item.key}
                        className="flex items-center justify-between p-4 rounded-xl bg-[var(--bg-soft)] cursor-pointer"
                ...
                <div className="p-4 rounded-xl bg-[var(--bg-soft)]">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-[var(--text-tertiary)]">Cập nhật lần cuối: 15 ngày trước</p>
                    </div>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between p-4 rounded-xl bg-[var(--bg-soft)]">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="font-medium text-[var(--text-primary)]">Windows PC - Chrome</p>
